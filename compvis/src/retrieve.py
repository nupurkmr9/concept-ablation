...
def retrieve(target_name, outpath, num_class_images):
    ...
    # client = ClipClient(url="https://knn5.laion.ai/knn-service", indice_name="laion5B-L-14", num_images=num_images,  aesthetic_weight=0.1) #laion_400m
